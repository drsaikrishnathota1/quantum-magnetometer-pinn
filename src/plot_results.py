...
def main():
    ...
    plt.plot(df["t"], df["Bayesian_PINN_mean"], label="Hybrid physics-calibrated PINN v3", alpha=0.90)
    plt.xlabel("Time")
    ...
    plt.xlabel("Time")
    plt.ylabel("Normalized magnetic field")
    plt.title("Hybrid Physics-Calibrated PINN v3 with Uncertainty Band")
    plt.legend()
    plt.tight_layout()
